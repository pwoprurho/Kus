...
''',
        ...
        "objects": [{"id": "ball", "name": "Ball", "type": "sphere", "physics": {"mass": 1}}],
...
''',
        "physics_config": {"gravity": [0, -9.81, 0], "timeScale": 1.0},
        "objects": [{"id": "bob", "name": "Pendulum Bob", "type": "sphere"}],
        "parameters": {"gravity": {"min": 1, "max": 20, "value": 9.81}},
...
''',
        "physics_config": {"gravity": [0, -9.81, 0], "timeScale": 1.0},
        "objects": [
            {"id": "ball1", "name": "Red Ball", "type": "sphere"},
            {"id": "ball2", "name": "Blue Ball", "type": "sphere"}
        ],
        "parameters": {"gravity": {"min": 1, "max": 20, "value": 9.81}},
...
''',
        "physics_config": {"gravity": [0, -9.81, 0], "timeScale": 1.0},
        "objects": [{"id": "ball", "name": "Projectile Ball", "type": "sphere"}],
        "parameters": {"gravity": {"min": 1, "max": 20, "value": 9.81}},
        "estimated_runtime": 5000
    }
}
